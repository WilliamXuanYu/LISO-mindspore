...
def get_loader(args):
    if args.eval:
        ...
        train = DataLoader(
            # f"E:/dataset/LISO-datasets/{args.dataset}/train/",
            f"/mnt/e/dataset/LISO-datasets/{args.dataset}/train/",
            limit=args.limit,
            shuffle=True,
    ...
    validation = DataLoader(
        # f"E:/dataset/LISO-datasets/{args.dataset}/val/",
        f"/mnt/e/dataset/LISO-datasets/{args.dataset}/val/",
        limit=np.inf,
        shuffle=False,
        batch_size=1,
        train=False,
